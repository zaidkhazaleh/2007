    ...
    $(function () {
        ...
        $('#contact_form').on('submit', function (e) {
            if (!e.isDefaultPrevented()) {
                $("#contact_form_submit_button").prop('disabled', true);
                $("#contact_form_spinner").prop('hidden', false);
                $.ajax({
                    type: "POST",
                    url: "contact",
                    data: $(this).serialize(),
                    success: function (data) {
                        $("#contact_form_submit_button").prop('disabled', false);
                        $("#contact_form_spinner").prop('hidden', true);
